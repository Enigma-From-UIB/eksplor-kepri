...
const ButtonScrollComponent = () => {
  const handleScroll = () => {
    const element = document.getElementById('penjelasan-belahbubung');
    if (element) {
  ...
  return (
    <div className="mt-05 ml-[100px] inline-block bg-primary bg-transparent hover:bg-lime-600 text-white font-semibold hover:text-white py-2 px-4 border border-lime-600 hover:border-lime-500 rounded-full text-sm "
    data-te-ripple-init
