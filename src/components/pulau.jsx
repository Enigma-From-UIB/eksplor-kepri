...
function Pulau() {
  return (
    <div className='flex'>
      <li>
        <h1 className='text-7xl font-serif font-bold text-white ml-20 text-left'>Natuna</h1>
        <button
          type="button"
      ...
      {/* Card 1 */}
      <div className="block rounded-lg bg-white p-10 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] green:bg-neutral-700 container flex justify-end container flex justify-end m-10  text-left w-200 h-300">
      ...
      {/* Card 2 */}
      <div className="block rounded-lg bg-white p-10 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] green:bg-neutral-700 container flex justify-end w-1/4 container flex justify-end m-10 text-center">
      <div class="mb-2 text-xl font-medium leading-tight text-neutral-800 green:text-neutral-50 font-sans text-lime-700">
      LINGGA </div>
      <button
          type="button"
